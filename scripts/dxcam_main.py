...
serialcomm = serial.Serial('CMO3',115200, timeout = 0)#com port for arduino
...
if __name__ == "__main__":
    ...
    model = torch.hub.load(r'C:\Users\PyPit\OneDrive\Documents\CODE\Valorant_arduino\yolov5', 'custom', path=r"C:\Users\PyPit\OneDrive\Documents\CODE\Valorant_arduino\scripts\best_nano_new.engine", _verbose=False, source= "local").eval().cuda()#loading model onto gpu
    ...
    while True:
        ...
        if closest_part != -1:
            ...
            if closest_part_distance < activation_range and aim_assist == True and send_next[0] == True:
                xdif = (head_center_list[0]-screenshot_center[0])*AIM_SPEED*target_multiply[MONITOR_SCALE]*smooth
                ydif = (head_center_list[1]-screenshot_center[1])*AIM_SPEED*target_multiply[MONITOR_SCALE]*smooth
