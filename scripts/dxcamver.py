...
if __name__ == "__main__":
    ...
    """
    target_multiply= [0,0,0,0,3.35,3.4] #depending on the screen ratio how much you move the mouse
...
# python yolov5-master\export.py --weights scripts/best_nano.pt --include onnx --device 0
